...
<form id="frmEmailNotify" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionUpdate" method="post" class="form pj-form clear_both">
		...
		<div id="tabs-1">
			...
			<p class="block t10">
				...
				<span class="block float_left r5">
					<select name="email_types" class="pj-form-field w300">
						<?php
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<p class="block t5">
							...
							<span class="block float_left r5">
								<textarea name="i18n[<?php echo $v['id']; ?>][confirm_tokens_client]" class="pj-form-field w500 h230 mceSelector"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['confirm_tokens_client']); ?></textarea>
							</span>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<p class="block t5">
							<label class="title" style="width: 130px"><?php __('confirmation_body'); ?></label>
							<span class="block float_left r5">
								<textarea name="i18n[<?php echo $v['id']; ?>][payment_tokens_client]" class="pj-form-field w500 h230 mceSelector"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['payment_tokens_client']); ?></textarea>
							</span>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<p class="block t5">
							<label class="title" style="width: 130px"><?php __('confirmation_body'); ?></label>
							<span class="block float_left r5">
								<textarea name="i18n[<?php echo $v['id']; ?>][confirm_tokens_admin]" class="pj-form-field w500 h230 mceSelector"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['confirm_tokens_admin']); ?></textarea>
							</span>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<p class="block t5">
							<label class="title" style="width: 130px"><?php __('confirmation_body'); ?></label>
							<span class="block float_left r5">
								<textarea name="i18n[<?php echo $v['id']; ?>][payment_tokens_admin]" class="pj-form-field w500 h230 mceSelector"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['payment_tokens_admin']); ?></textarea>
							</span>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<p class="block t5">
							<label class="title" style="width: 130px"><?php __('confirmation_body'); ?></label>
							<span class="block float_left r5">
								<textarea name="i18n[<?php echo $v['id']; ?>][register_tokens]" class="pj-form-field w500 h230 mceSelector"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['register_tokens']); ?></textarea>
							</span>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<p class="block t5">
							<label class="title" style="width: 130px"><?php __('confirmation_body'); ?></label>
							<span class="block float_left r5">
								<textarea name="i18n[<?php echo $v['id']; ?>][forgot_tokens]" class="pj-form-field w500 h230 mceSelector"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['forgot_tokens']); ?></textarea>
							</span>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
			...
			<div class="emailBox7">
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						<p class="block t5">
							<label class="title" style="width: 130px"><?php __('confirmation_subject'); ?></label>
							<input type="text" name="i18n[<?php echo $v['id']; ?>][send_to_subject]" class="pj-form-field w500 b10" value="<?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['send_to_subject'])); ?>" />
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
						</p>
						<p class="block t5">
							...
							<span class="block float_left r5">
								<textarea name="i18n[<?php echo $v['id']; ?>][send_to_tokens]" class="pj-form-field w500 h230 mceSelector"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['send_to_tokens']); ?></textarea>
							</span>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
