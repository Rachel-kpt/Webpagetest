				...
				<div class="scPaperSheet">
					...
					<div class="scPaperContent">
						...
						<p class="scPaperUnchained">
							...
							<img src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&amp;action=pjActionCaptcha&amp;rand=<?php echo rand(1, 99999); ?><?php echo isset($_GET['session_id']) && !empty($_GET['session_id']) ? '&session_id=' . pjSanitize::clean($_GET['session_id']) : NULL;?>" alt="Captcha" style="vertical-align: middle" />
