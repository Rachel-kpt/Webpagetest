							...
							<div class="col-sm-6">
								<div class="form-group required">
									...
									<div class="row">
									  	...
									  	<div class="col-xs-6">
									    	<img src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&amp;action=pjActionCaptcha&amp;rand=<?php echo rand(1,99999); ?><?php echo isset($_GET['session_id']) ? '&session_id=' . $_GET['session_id'] : '';?>" alt="Captcha" style="cursor: pointer;" class="scCaptcha scSelectorCaptcha" />
									  	</div>
