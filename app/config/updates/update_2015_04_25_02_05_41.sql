...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'No categories found. Add category {STAG}here{ETAG}.', 'script');

INSERT INTO `fields` VALUES (NULL, 'infoProductsTitle', 'backend', 'Infobox / List of products', 'script', NULL);

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'List of products', 'script');

INSERT INTO `fields` VALUES (NULL, 'infoProductsDesc', 'backend', 'Infobox / List of products', 'script', NULL);

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'You can find below the list of products defined. Click on the pencil icon on the corresponding entry to view more details of a specific product. You can also click on the button "+ Add product" to add new product.', 'script');
