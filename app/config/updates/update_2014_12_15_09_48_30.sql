...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', '[PRODUCT] has been purchased [X] times. Deleting the product will also remove it from all these orders. Are you sure you want to delete it or make it inactive?', 'script');
...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Are you sure you want to delete the product?', 'script');
