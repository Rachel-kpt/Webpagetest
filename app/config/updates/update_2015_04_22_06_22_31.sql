...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'You can find below the list of clients. Click on the Pencil icon on the corresponding entry to view client details.', 'script');
...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'List of orders', 'script');

INSERT INTO `fields` VALUES (NULL, 'infoOrdersDesc', 'backend', 'Infobox / List of orders', 'script', NULL);

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'You can find below the list of orders made. Click on the pencil icon on the corresponding entry to view more details of a specific order.', 'script');
