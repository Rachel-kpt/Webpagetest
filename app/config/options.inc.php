...
if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "4.2");
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "57");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "4.2.6");
...
if (!defined("PJ_INVOICE_PLUGIN")) define("PJ_INVOICE_PLUGIN", 'index.php?controller=pjAdminOrders&action=pjActionUpdate&uuid={ORDER_ID}');
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin',  'pjAuthorize', 'pjPaypal', 'pjInvoice', 'pjGallery', 'pjSms', 'pjCountry');
?>